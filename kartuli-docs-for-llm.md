...
Generated: 2025-10-10T16:20:37.107Z
Source: README.md
...
| Package Manager | pnpm | Planned | Workspace management |
| Build System | turborepo | Planned | Monorepo management |
| Language | TypeScript | Planned | |
| Linting | Eslint | Planned | |
| Formatting | Prettier | Planned | |
| Styling | Tailwind | Planned | |
| UI Library | React | Planned | |
| UI Components | react-aria | Planned | Accessibility, WCAG compliance |
| Framework | Nextjs | Planned | App router|
| Bundler | Turbopack | Planned | Next.js applications |
| Bundler | Vite | Planned | Storybook, VitePress |
| Storage (Client) | rxdb | Planned | Sync management |
| Storage (Client) | IndexedDB | Planned | Offline support|
| Storage (Client) | Cache Storage | Planned | PWA asset caching |
| Infrastructure | cdn | Planned | Cloudflare |
| Database (Server) | Postgres | Planned | Supabase |
| Platform | PWA | Planned | Installable app |
| Testing | vitest | Planned | Integration tests, unit tests|
| Testing | playwright | Planned | e2e tests |
| Quality | Lighthouse CI | Planned | Performance, accessibility monitoring, runs on GitHub Actions |
| Search | Fuse.js | Planned | Client-side, offline-first |
| Internationalization | | TBD | Options: intlayer, next-intl, i18next |
| Content | Markdown | Active | Documentation, info pages (terms, privacy) |
| Documentation & Development | Storybook | Planned | Component development, documentation |
| Documentation Site | VitePress | Planned | Project documentation, hosted on GitHub Pages |

### Providers

1 entry per service, even if same provider

| Provider | Service | Status | Links | Notes |
| -------- | ------- | ------ | ----- | ----- |
| GitHub | Version Control | Active | https://github.com/rocescoca/ | |
| GitHub | CI/CD | Active | https://github.com/rocescoca/ | labels sync, labels propagation from Issue to PR |
| GitHub | Projects | Active | https://github.com/rocescoca/ | Issue tracking, project boards |
| GitHub | Hosting | Planned | https://pages.github.com | VitePress documentation site |
| Qodo | AI Code Review | Planned | https://qodo.ai | GitHub integration |
| Vercel | Hosting | Planned | https://vercel.com | Next.js optimized |
| Vercel | Serverless Functions | Planned | https://vercel.com | API endpoints |
| Supabase | Database | Planned | https://supabase.com | Students Activity, CMS |
| Supabase | Authentication | Planned | https://supabase.com | Google, Facebook social login |
| Supabase | File Storage | Planned | https://supabase.com | Assets, content packs |
| Cloudflare | CDN | Planned | https://cloudflare.com | Serves assets and content packs from Supabase |
| Cloudflare | Domain | Active | https://cloudflare.com | |
| Cloudflare | Email Services | Planned | https://cloudflare.com | Newsletters, transactional emails |
| PostHog | Analytics | Planned | https://posthog.com | User behavior, consent-based |
| Sentry | Error Tracking | Planned | https://sentry.io | |
| New Relic | Performance Monitoring | Planned | https://newrelic.com | |
| BetterStack | Uptime Monitoring | Planned | https://betterstack.com | Heartbeats, status pages |
| Chromatic | Visual Testing | Planned | https://chromatic.com | Visual regression, UI review |
| Tally | Forms & Surveys | Planned | https://tally.so | Anonymous surveys, user feedback |
