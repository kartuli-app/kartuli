...
interface SharedAlphabetItemRow {
  id: string;
  type: 'letter';
  targetScript: string;
...
interface SharedVocabularyItemRow {
  id: string;
  type: 'word';
  targetScript: string;
  source: string;
...
type SharedItemRow = SharedAlphabetItemRow | SharedVocabularyItemRow;
...
type CombinedSharedContentRows = {
