...
const meta: Meta<typeof PanelActionButton> = {
  title: 'UI/Actions/PanelActionButton',
  component: PanelActionButton,
  parameters: {
    layout: 'centered',
    docs: {
      description: {
        component:
          'Panel-surface action button with a built-in tooltip. Used by translit panel headers and still exported through the legacy `HeaderActionButton` and `TooltipButton` aliases for compatibility.',
      },
    },
  },
  decorators: [
