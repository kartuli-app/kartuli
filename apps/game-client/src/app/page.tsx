...
export default function Page() {
  return (
    <div>
      ...
      <div className="hidden fixed bottom-4 right-4 bg-gray-900 text-white p-4 rounded-lg shadow-lg text-xs font-mono max-w-sm border border-gray-700 text-blue-400 text-cyan-400 text-yellow-400 text-purple-400 text-orange-400 text-indigo-400 text-gray-400 text-gray-300">
        Force debug panel styles
      </div>
