...
- Lessons: 4–6 items, balanced by skill or theme, mixing letters or words only within their module type; recommended lessons are generated by the recomendation algorthim
...
- Banner includes each toggle pre checked to yes,acept buton to confirm the choice, link to privacy page
